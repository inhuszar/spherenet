...
def main():
    ...
    parser.add_argument(
        "--optimizer", type=str, default="adam", help='optimizer, options={"adam, sgd"}'
    )
    parser.add_argument(
    ...
    if args.data == "FashionMNIST":
        train_dataset = OmniFashionMNIST(
            fov=120, flip=True, h_rotate=True, v_rotate=True, img_std=255, train=True
        )
        test_dataset = OmniFashionMNIST(
            fov=120,
            flip=True,
            h_rotate=True,
            v_rotate=True,
        ...
        train_dataset = OmniMNIST(
            fov=120, flip=True, h_rotate=True, v_rotate=True, train=True
        )
        test_dataset = OmniMNIST(
            fov=120, flip=True, h_rotate=True, v_rotate=True, train=False, fix_aug=True
        )
    ...
    if args.optimizer == "adam":
        ...
        sphere_optimizer = torch.optim.SGD(
            sphere_model.parameters(), lr=args.lr, momentum=args.momentum
        )
